...
namespace Mititean_Ionut_Daniel_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Mititean_Ionut_Daniel_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Mititean_Ionut_Daniel_Lab2Context context,
